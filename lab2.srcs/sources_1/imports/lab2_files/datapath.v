...
module datapath (
  ...
  wire [9:0] pc_plus4, pc_plusBranch, jump_addr;
  wire [31:0] instr;
  ...
  always @(posedge clk or posedge reset) begin
    if (reset) pc <= 10'b0000000000;
    else if (branch && zero) pc <= pc_plusBranch;
    else if (jump) pc <= jump_addr;
    else pc <= pc_plus4;
  end

  assign pc_plus4 = pc + 10'b0000000100;
  assign pc_plusBranch = pc_plus4 + $signed(imm_value << 2);
  assign jump_addr = instr[25:0] << 2;
